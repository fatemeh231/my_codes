...
size_number= [19,4,13,15,13,13,8,6,8,14,11,10,2]
...
size_number1= [92,100,92,100,100,92,100,100,88,93,73,100,50]
...
plt.suptitle("Trade analysis overview for the fourth winner", fontsize=16)
plt.tight_layout()
plt.show()